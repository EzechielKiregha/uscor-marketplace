...
var ReceiptEmail = function (_a) {
    ...
    return (React.createElement(components_1.Html, null,
        ...
        React.createElement(components_1.Preview, null, "Ton recu Uscor Market"),
        React.createElement(components_1.Body, { style: main },
            React.createElement(components_1.Container, { style: container },
                ...
                React.createElement(components_1.Section, { style: productTitleTable },
                    React.createElement(components_1.Text, { style: productsTitle }, "Commande en bref")),
                products.map(function (product) {
                    ...
                    return (React.createElement(components_1.Section, { key: product.id },
                        ...
                        React.createElement(components_1.Column, { style: { paddingLeft: '22px' } },
                            ...
                            React.createElement(components_1.Link, { href: "".concat(process.env.NEXT_PUBLIC_SERVER_URL, "/thank-you?orderId=").concat(orderId), style: productLink }, "Telecharge - produit")),
                ...
                React.createElement(components_1.Text, { style: footerLinksWrapper },
                    React.createElement(components_1.Link, { href: '#' }, " Parametres du compte"),
                    " \u2022",
                    ' ',
                    React.createElement(components_1.Link, { href: '#' }, "Regles de vente"),
                    " \u2022",
                    ' ',
                    React.createElement(components_1.Link, { href: '#' }, "Privacy Policy ")),
                React.createElement(components_1.Text, { style: footerCopyright },
                    "Copyright \u00A9 2023 Uscor-Market Inc. ",
                    React.createElement("br", null),
                    ' ',
                    React.createElement(components_1.Link, { href: '#' }, "Tout les droits sont reserver"))))));
};
